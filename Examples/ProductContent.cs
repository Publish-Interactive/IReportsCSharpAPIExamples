...
namespace IReportsApiExamples.Examples
{
    public class ProductContent
    {
        ...
        {
            await GetAttachment(iReportsLibrary, "ER123", "ER123.pdf");
            await GetContent(iReportsLibrary, "ER113Brief");
            await GetToc(iReportsLibrary, "ER123");
        }

        public static async Task<ProductTocModel> GetToc(IReportsLibrary iReportsLibrary, string productCode)
        {
        ...
        public static async Task<FileDownloadModel> GetAttachment(IReportsLibrary iReportsLibrary, string productCode, string fileCode)
        {
        ...
        public static async Task<ProductContentModel> GetContent(IReportsLibrary iReportsLibrary, string productCode)
        {
